<!--
Template for the "(User) Register" form.
    ...
    <div id="registerform">
        <form method="post">
            ...
            <dl>
                ...
                <dd>
                    {if isset($user)}
                        <input type="text" name="username" class="registerfield" maxlength="50" value="{$user->getUsername()}"/> <span class="fieldnote">mind. 5 Zeichen</span>
                    {else}
                        <input type="text" name="username" class="registerfield" maxlength="50" /> <span class="fieldnote">mind. 5 Zeichen</span>
                    {/if}
                </dd>
                <dt>
                   Password
